 ...
 * the file FILE_from, 99 when it can not open/ write to the FILE_TO and
 ...
 * @buff: an array of chars containing up to 1024 chars
 * @to_fd: file descriptor of file TO_FILE
 * @read_chars: a number representing how many chars were read and need to
 * be written.
 * @f_to: name of the file FILE_TO
 * Return: always 0. Exit 99
 */
int write_to_file(char *buff, int to_fd, int read_chars, char *f_to)
{
	int i;
